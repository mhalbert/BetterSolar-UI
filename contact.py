...
def window():
    ...
    layout = [
        ...
        [sg.InputText('emailaddresshere@gmail.com', size=(300,1), justification='c', use_readonly_for_disable=True, disabled=True, key='-IN-', font='Sathu 12 underline', text_color='#1a385c')]
    ]
